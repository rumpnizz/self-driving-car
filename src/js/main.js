...
let bestBrain = localStorage.getItem("bestBrain") || window.bestCarData;
...
function save() {
    let bestBrainData = JSON.stringify(bestCar.brain);
    localStorage.setItem("bestBrain", bestBrainData);
    console.log('Your brain: \n' + bestBrainData);
}
